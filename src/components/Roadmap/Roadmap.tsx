      ...
      <Slider {...settings}>
        <div className="each-road">
          ...
          <p>
            ...
            <strong>Dec. 2nd</strong> @ 3:00 PM PST. 2,000 NFT's Baby Mutant
        ...
        <div className="each-road">
          ...
          <p>
            ...
            <strong>Dec. 5th</strong> @ 3:00PM PST. 8,000 Baby Mutant Punks will
            be released at the Mint price of 0.75 Solana.
          </p>
        </div>
        <div className="each-road">
          <h1>40%</h1>
